...
export function TourContentManager({ tourId, itinerary, hotels, services, notes, faqs, gallery }: { tourId: string; itinerary: readonly Itinerary[]; hotels: readonly Hotel[]; services: readonly Service[]; notes: readonly Note[]; faqs: readonly Faq[]; gallery: readonly GalleryItemView[] }) {
