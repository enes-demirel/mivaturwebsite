...
export default async function EditTourPage({ params, searchParams }: EditTourPageProps) {
  ...
  const [{ data: tour }, { data: departures }, { data: gallery }] = await Promise.all([
