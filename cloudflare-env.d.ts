/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 590415b3368c72786a06e0fd95edb1f5)
// Runtime types generated with workerd@1.20260815.1 2026-08-19 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	MIVATUR_MEDIA: R2Bucket;
	NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
	MIVATUR_DB: D1Database;
	ASSETS: Fetcher;
	NEXT_PUBLIC_SUPABASE_URL: string;
	NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY: string;
	WORKER_SELF_REFERENCE: Fetcher /* mivatur */;
}
